...
import VBaseInput from './VBaseInput';

export default class VInput extends VBaseInput {
	static defaultProps = {
		...VBaseInput.defaultProps,
		...{
			tag: Input,
		},
	};

	static contextTypes = VBaseInput.contextTypes;
	...
	render() {
		...
		return <Tag {...attributes} ref={getRef} {...this.getValidatorProps()} className={classes} value={value} id={id} />;
	}
}
