...
class ServerError extends Component<IProps, IState> {
	public props: IProps;
	public state: IState;
	...
	public render(): ReactNode {
		return (
			<>
				<Line title="Internal Server Error" description="500" />

				<Container className="section features-1 pt-0">
					<div className="m-lg">
						<h1 className="text-white">500 - Internal Server Error</h1>
						<h2 className="text-white">It looks like you're lost.</h2>
						<h3 className="text-white">The page you're looking for isn't working.</h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(ServerError));
