...
export interface IFormAction extends ModalAction {
	payload?: {
		modal: IModalType;
		props?: IFormProps;
	};
...
interface IProps extends IFormProps, InjectedProps {
...
export default class DynamicModal extends Component<IDynamicProps, IDynamicState> {
	public render(): ReactNode {
		...
		const WrappedMyModal: ComponentClass<any, any> = connectModal({ name, destroyOnHide: true })(FormModal);
