...
export interface IUserAction extends ModalAction {
	payload?: {
		modal: IModalType;
		props?: IUserProps;
	};
...
interface IProps extends IUserProps, InjectedProps {
...
export default class DynamicModal extends Component<IDynamicProps, IDynamicState> {
	public render(): ReactNode {
		...
		const WrappedMyModal: ComponentClass<any, any> = connectModal({ name, destroyOnHide: true })(UserModal);
